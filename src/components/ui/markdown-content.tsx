...
const components: Partial<Components> = {
	...
	// <a data-type="pdf-link" data-pdf-id="31242432" data-pdf-page="1">[Paper 1, Page 1]</a>
	a: ({
		children,
		...props
		...
		if (dataType === "pdf-link") {
			const pdfId = props["data-pdf-id"];
			const pdfPage = props["data-pdf-page"] || "1"; // Default to page 1
			const pdfChunkIndex = props["data-chunk-index"];
			return (
				<FetchPdfButton
					pdfId={pdfId}
					pdfPage={pdfPage}
					pdfChunkIndex={pdfChunkIndex}
				>
					{children}
				</FetchPdfButton>
			);
